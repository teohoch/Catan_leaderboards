...
5.times {
  FactoryGirl.create(:tournament, :free4all, :with_inscriptions, :with_users, available_users: users.slice(0..8), number_players: 9, n_registered: 9, officer: fuser, rounds: 2)
  sleep(0.2)
}